...
public class InterbaseNewGuidTranslator : IMethodCallTranslator
{
	readonly InterbaseSqlExpressionFactory _interbaseSqlExpressionFactory;

	public InterbaseNewGuidTranslator(InterbaseSqlExpressionFactory interbaseSqlExpressionFactory)
	{
	...
	public SqlExpression Translate(SqlExpression instance, MethodInfo method, IReadOnlyList<SqlExpression> arguments, IDiagnosticsLogger<DbLoggerCategory.Query> logger)
	{
		...
		{
			return _interbaseSqlExpressionFactory.Function("GEN_UUID", Array.Empty<SqlExpression>(), false, Array.Empty<bool>(), typeof(Guid));
		}
		return null;
	}
}
