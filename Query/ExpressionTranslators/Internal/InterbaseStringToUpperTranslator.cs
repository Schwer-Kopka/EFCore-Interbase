...
public class InterbaseStringToUpperTranslator : IMethodCallTranslator
{
	readonly InterbaseSqlExpressionFactory _interbaseSqlExpressionFactory;

	public InterbaseStringToUpperTranslator(InterbaseSqlExpressionFactory interbaseSqlExpressionFactory)
	{
	...
	public SqlExpression Translate(SqlExpression instance, MethodInfo method, IReadOnlyList<SqlExpression> arguments, IDiagnosticsLogger<DbLoggerCategory.Query> logger)
	{
		...
		{
			return _interbaseSqlExpressionFactory.Function("UPPER", new[] { instance }, true, new[] { true }, typeof(string));
		}
		return null;
	}
}
